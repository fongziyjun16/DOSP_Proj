...
{
 "use strict";
 var ClientServer,Client,ClientServer_Templates,WebSharper,Concurrency,Remoting,AjaxRemotingProvider,UI,Var$1,Templating,Runtime,Server,ProviderBuilder,Handler,TemplateInstance,Client$1,Templates;
 ...
 Client.Main$19$20=function(rvReversed)
 {
  return function(e)
  {
   ...
   {
    return Concurrency.Bind((new AjaxRemotingProvider.New()).Async("ClientServer:ClientServer.Server.DoSomething:1913252452",[e.Vars.Hole("texttoreverse").$1.Get()]),function(a)
    {
     rvReversed.Set(a);
 ...
 Client.Main=function()
 {
  ...
  },function(e)
  {
   ...
   $0:"reversed",
   $1:R
  }),_this))),(p=Handler.CompleteHoles(b.k,b.h,[["texttoreverse",0]]),(i=new TemplateInstance.New(p[1],ClientServer_Templates.mainform(p[0])),b.i=i,i))).get_Doc();
 };
 ClientServer_Templates.mainform=function(h)
 {
